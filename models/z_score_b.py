...
def calc_z_score(cell_data, te):
    ...
    feature_low = np.array(['scgfail', 'scgfailratio', 'cslcucp', 'totprbulavg', 'totprbdlavg', 'csldu', 'bler_ul',
                            'bler_dl', 'rssipathavg', 'outofsynccount'])
    feature_low_cnt = np.array(['scgfail', 'cslcucp', 'totprbulavg', 'totprbdlavg', 'csldu', 'outofsynccount'])
    ...
    cls_feature_name = np.array(['scgfail', 'totprbdlavg', 'erabaddrate', 'uenomax', 'endcmodbymenbrate', 'cslcucp',
                   ...
                   'dlreceivedriavg', 'rachrarrate', 'rachpreamblea'])
    ...
    z_score_1[feature_high_cnt] = 1.6 * np.log10(1 + temp) / np.log10(3) + 0.2 * temp
    z_score_1_scale[feature_high_cnt] = 1.7 * np.log10(1 + temp) / np.log10(3) + 0.15 * temp
    ...
    z_score_2[feature_mid_cnt] = 1.6 * np.log10(1 + temp) / np.log10(3) + 0.2 * temp
    z_score_2_scale[feature_mid_cnt] = 1.7 * np.log10(1 + temp) / np.log10(3) + 0.15 * temp
    ...
    z_score_3[feature_low_cnt] = np.log10(1 + temp) / np.log10(3) + 0.5 * temp
    z_score_3_scale[feature_low_cnt] = 1.4 * np.log10(1 + temp) / np.log10(3) + 0.3 * temp
    ...
    z_score_norm = (z_score_1_norm.sum(1) + z_score_2_norm.sum(1) + z_score_3_norm.sum(1))**0.5
